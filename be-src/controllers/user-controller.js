...
var SECRET_KEY = "mecomiunasalchipapamecomiunasalchipapaayquecosatansabrozaysemeatoroenlagargantaporquenomealcanzopalagaseosa";
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    auth = _a.sent();
                    token = jwt.sign({ id: auth.get("user_id") }, SECRET_KEY);
                    if (auth) {
